...
namespace IWantApp.Endpoints.Products
{
    ...
    {
        public static string Template => "/products/showscase";
        public static string[] Methods => new string[] { HttpMethod.Get.ToString() };
        public static Delegate Handle => Action;

        [AllowAnonymous]
        public async static Task<IResult> Action(ApplicationDbContext context, int page = 1 , int row = 10, string orderBy  = "Name")
        {
            if (row > 10)
